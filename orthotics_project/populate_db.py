...
def populate():
    ...
    add_perscription(eric, datetime.date(2014, 5, 1))
    add_perscription(chris, datetime.date(2014, 5, 1))
    add_perscription(jay, datetime.date(2014, 5, 1))
    add_perscription(dan, datetime.date(2014, 5, 1))
    add_perscription(cloney, datetime.date(2014, 5, 1))
    add_perscription(cloney, datetime.date(2014, 5, 2))
    add_perscription(jane, datetime.date(2014, 5, 1))
    add_perscription(john, datetime.date(2014, 5, 1))
